...
function customize_for_this_tab() {
  ...
  BG.getCurrentTabInfo(function(info) {
    ...
    var paused = BG.adremover_is_paused();
    if (paused) {
      show(["div_status_paused", "separator0", "div_options"]);
    } else if (info.disabled_site) {
      show(["div_status_disabled", "separator0", "div_pause_adremover",
            "div_options", "div_help_hide_start"]);
    } else if (info.whitelisted) {
      show(["div_status_whitelisted", "div_show_resourcelist",
            "separator0", "div_pause_adremover", "separator1",
            "div_options", "div_help_hide_start"]);
    } else {
      show(["div_pause_adremover", "div_blacklist", "div_whitelist",
...
$(function() {
  ...
  $("#div_pause_adremover").click(function() {
    BG.adremover_is_paused(true);
    BG.updateButtonUIAndContextMenus();
    window.close();
  });
  ...
  $("#ce-rating-link").click(function() {
    window.open("https://chrome.google.com/webstore/detail/adremover-for-google-chro/mcefmojpghnaceadnghednjhbmphipkb/reviews");
  });
...
$(function() {
  ...
  var linkHref = "https://chrome.google.com/webstore/detail/adremover-for-google-chro/mcefmojpghnaceadnghednjhbmphipkb/";
