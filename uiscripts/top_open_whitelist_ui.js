...
function top_open_whitelist_ui() {
  ...
  load_jquery_ui(function() {
    var adremover_default_button_text = translate("buttonexclude");
    var btns = {};
    ...
    var page = $("<div>").
      append('<span>' + translate("adremover_wont_run_on_pages_matching") +
             '</span>').
      ...
      dialog({
        ...
        dialogClass: "adremover-whitelist-dialog",
        width: 600,
        minHeight: 130,
        buttons: btns,
        close: function() {
      ...
      changeTextDirection($("body .adremover-whitelist-dialog"));
