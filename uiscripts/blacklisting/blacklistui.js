...
BlacklistUi.prototype._onClose = function() {
  if (this._cancelled == true) {
    ...
    $(".adremover-ui-stylesheet").remove();
...
BlacklistUi.prototype._build_page1 = function() {
  ...
  var btns = {};
  var adremover_default_button_text = translate("buttonlooksgood");
  btns[adremover_default_button_text] = {
    text: adremover_default_button_text,
    'class': 'adremover_default_button',
    click: function() {
  ...
  page.dialog({
      dialogClass: "adremover-blacklist-dialog",
      position: [50, 50],
      width: 410,
      autoOpen: false,
  ...
  changeTextDirection($("body .adremover-blacklist-dialog"));
...
BlacklistUi.prototype._build_page2 = function() {
  ...
  var page = $("<div>" + translate("blacklisteroptions1") +
    "<div>" +
      "<div id='adremover-details'></div><br/>" +
      "<div id='count'></div>" +
    "</div>" +
    "<div>" +
  ...
  var btns = {};
  var adremover_default_button_text = translate("buttonblockit");
  btns[adremover_default_button_text] = {
    text: adremover_default_button_text,
    'class': 'adremover_default_button',
    click: function() {
  ...
  page.dialog({
      dialogClass: "adremover-blacklist-dialog ui-page-2",
      position:[50, 50],
      width: 500,
      autoOpen: false,
...
BlacklistUi.prototype._makeFilter = function() {
  ...
  var el = this._chain.current();
  var detailsDiv = $("#adremover-details", this._ui_page2);
...
BlacklistUi.prototype._redrawPage2 = function() {
  ...
  var detailsDiv = $("#adremover-details", that._ui_page2);
...
BlacklistUi.prototype._preview = function(selector) {
  $("#adremover_blacklist_preview_css").remove();
  if (!selector) return;

  var css_preview = document.createElement("style");
  css_preview.type = "text/css";
  css_preview.id = "adremover_blacklist_preview_css";

  var d = "body .adremover-blacklist-dialog";

  switch (this._current_step) {
  case 0:
    // Raise highlight.
    css_preview.innerText = "body .adremover-highlight-node,";
    break;
  case 1:
    // Show ui_page1.
  ...
  case 2:
    ...
    css_preview.innerText = d + " input, " + d +
      ...
      " center {display:block!important;} " +  d + " #adremover-details, " + d +
