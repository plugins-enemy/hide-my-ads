...
// EasyList, adremover custom and (if any) a localized subscription
// Inputs: none.
...
MyFilters.prototype._load_default_subscriptions = function() {
  ...
  result["adremover_custom"] = { subscribed: true };
...
MyFilters.prototype._make_subscription_options = function() {
  ...
  return {
    "adremover_custom": { // adremover custom filters
      url: "http://cdn.filterrules.com/filters/AdRemoverCustom",
    },

    "easylist": { // EasyList
      url: "http://cdn.filterrules.com/filters/Easylist"
    },
    "easylist_plus_bulgarian": { // Additional Bulgarian filters
      url: "http://cdn.filterrules.com/filters/EasylistBG",
      requiresList: "easylist",
    },
    "dutch": { // Additional Dutch filters
      url: "http://cdn.filterrules.com/filters/EasylistNL",
      requiresList: "easylist",
    },
    "easylist_plus_finnish": { // Additional Finnish filters
      url: "http://cdn.filterrules.com/filters/EasylistFI",
      requiresList: "easylist",
    },
    "easylist_plus_french": { // Additional French filters
      url: "http://cdn.filterrules.com/filters/EasylistFR",
      requiresList: "easylist",
    },
    "easylist_plus_german": { // Additional German filters
      url: "http://cdn.filterrules.com/filters/EasylistDE",
      requiresList: "easylist",
    },
    "easylist_plus_greek": { // Additional Greek filters
      url: "http://cdn.filterrules.com/filters/EasylistGR",
      requiresList: "easylist",
    },
    "easylist_plus_indonesian": { // Additional Indonesian filters
      url: "http://cdn.filterrules.com/filters/EasylistID",
      requiresList: "easylist",
    },
    "easylist_plus_polish": { // Additional Polish filters
      url: "http://cdn.filterrules.com/filters/EasylistPL",
      requiresList: "easylist",
    },
    "easylist_plus_romanian": { // Additional Romanian filters
      url: "http://cdn.filterrules.com/filters/EasylistRO",
      requiresList: "easylist",
    },
    "russian": { // Additional Russian filters
      url: "http://cdn.filterrules.com/filters/EasylistRU",
      requiresList: "easylist",
    },
    "chinese": { // Additional Chinese filters
      url: "http://cdn.filterrules.com/filters/EasylistCN",
      requiresList: "easylist",
    },
    "czech": { // Additional Czech and Slovak filters
      url: "http://cdn.filterrules.com/filters/EasylistSK",
      requiresList: "easylist",
    },
    "danish": { // Danish filters
      url: "http://cdn.filterrules.com/filters/ListDanish",
    },
    "hungarian": { // Hungarian filters
      url: "http://cdn.filterrules.com/filters/ListHungarian",
    },
    "israeli": { // Israeli filters
      url: "http://cdn.filterrules.com/filters/ListIsaraeli",
    },
    "italian": { // Italian filters
      url: "http://cdn.filterrules.com/filters/ListItalian",
    },
    "japanese": { // Japanese filters
      url: "http://cdn.filterrules.com/filters/ListJapanese",
    },
    "easylist_plun_korean": {  // Korean filters
      url: "http://cdn.filterrules.com/filters/ListKorean",
    },
    "latvian": {  // Latvian filters
      url: "http://cdn.filterrules.com/filters/ListLatviaan",
    },
    "norwegian": {  // Additional Norwegian filters
      url: "http://cdn.filterrules.com/filters/ListNorwegian",
      requiresList: "easylist",
    },
    "easylist_plus_spanish": {  // Spanish filters
      url: "http://cdn.filterrules.com/filters/ListSpanish",
    },
    "swedish": {  // Swedish filters
      url: "http://cdn.filterrules.com/filters/ListSwedish",
    },
    "turkish": {  // Turkish filters
      url: "http://cdn.filterrules.com/filters/ListTurkish",
    },
    "easyprivacy": { // EasyPrivacy
      url: "http://cdn.filterrules.com/filters/EasylistPivacy",
    },
    "antisocial": { // Antisocial
      url: "http://cdn.filterrules.com/filters/EasylistAntisocial",
    },
    "malware": { // Malware protection
      url: "http://cdn.filterrules.com/filters/EasylistMalware",
    },
	"annoyances": { // Fanboy's Annoyances
      url: "http://cdn.filterrules.com/filters/EasylistAnnoyances",
	},
  };
}
